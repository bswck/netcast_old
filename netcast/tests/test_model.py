...
class TestModel:
    def test_subclass_creation(self):
        ...
        assert isinstance(Foo.abc, nc.Rep)
        assert Foo.abc.name == "abc"
        assert isinstance(Foo.bar, nc.Rep)
        assert Foo.bar.name == "bar"
        assert isinstance(Foo.alias, nc.Proxy)
        ...
        assert isinstance(Bar.foo, nc.Rep)
    ...
    def test_functional_creation(self):
        ...
        assert isinstance(bar_model.foo, nc.Rep)
